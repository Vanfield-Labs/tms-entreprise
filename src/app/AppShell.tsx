...
function NotificationBell({
  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      {open && (
        <div
          className="absolute right-0 top-full mt-2 w-80 sm:w-96 rounded-2xl shadow-2xl border overflow-hidden z-50"
            ...
            <div className="flex items-center gap-3 min-w-0">
              ...
              {!desktopCollapsed && (
                <div className="min-w-0 hidden lg:block">
                  <p className="text-sm font-bold text-[color:var(--text)] leading-tight">
                    TMS Portal
                  </p>
